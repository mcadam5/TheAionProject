...
namespace TheAionProject
{
    ...
    public class ConsoleView
    {
        ...
        ///// </summary>
        ///// <returns>integer value</returns>
        //public bool GetTrueFlase(string prompt)
        //{
        //    bool validResponse = false;
        ...
        //            if (true)
        //            {
        //                DisplayInputBoxPrompt("You are an experienced traveler.");
        //                DisplayInputBoxPrompt("Thanks for traveling again");
        //                validResponse = true;
        //            }
        //            else
        //            {
        //                ClearInputBox();
        //                DisplayInputErrorMessage($"You must respond True or False. Please try again.");
        //                DisplayInputBoxPrompt(prompt);
        //            }
        //        }
        //        else
        ...
        public Traveler GetInitialTravelerInfo()
        {
            ...
            //
            // get traveler's experience
            //
            //DisplayGamePlayScreen("Mission Initialization - Experience Level", Text.InitializeMissionGetTravelerExperience(traveler.Name), ActionMenu.MissionIntro, "");
            //DisplayInputBoxPrompt("True or False you have galactically traveled before: ");
            //traveler.HasTraveled = GetBoolean();
